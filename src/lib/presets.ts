...
const VS_OPEN_DEFAULTS_V2: Record<string, { call: string; threeBet: string }> = {
  ...
  BTN_vs_UTG: {
    threeBet: 'QQ,KK,AA,AKs,AKo,AQs,AQo',
  ...
  BTN_vs_HJ: {
    ...
    call: '22,33,44,55,66,77,88,A9s,ATs,AJo,KTs,KQo,QTs,QJs,QJo,JTs,JTs,T9s,98s,87s,76s,65s,54s',
  },
  BTN_vs_CO: {
    // AQs MUST continue (call or 3bet) — never fold.
    threeBet: '99,TT,JJ,QQ,KK,AA,AKs,AKo,AQs,AQo,A5s,A4s,KQs,KJs,QJs,JTs',
    call: '22,33,44,55,66,77,88,A2s,A3s,A6s,A7s,A8s,A9s,ATs,AJs,AJo,KTs,K9s,KQo,QTs,QJo,T9s,98s,87s,76s,65s,54s,JTo,T9o',
  },

  SB_vs_UTG: {
    threeBet: 'JJ,QQ,KK,AA,AKs,AKo,AQs',
    call: '66,77,88,99,TT,AQo,AJs,KQs,QJs,JTs,T9s,98s',
  },
  SB_vs_UTG1: {
    threeBet: 'JJ,QQ,KK,AA,AKs,AKo,AQs,AQo',
  ...
  SB_vs_HJ: {
    threeBet: '99,TT,JJ,QQ,KK,AA,AKs,AKo,AQs,AQo,AJs,A5s,KQs,KJs,QJs',
    call: '44,55,66,77,88,A9s,ATs,AJo,KTs,QTs,JTs,T9s,98s,87s,76s,65s',
  },
  SB_vs_CO: {
  ...
  SB_vs_BTN: {
    ...
    call: '44,55,66,77,A6s,A7s,A8s,A9s,ATs,AJs,AJo,K9s,KTs,KQo,QTs,QJo,JTo,J9s,T8s,87s,76s,65s',
  },

  BB_vs_UTG: {
    threeBet: 'QQ,KK,AA,AKs,AKo,AQs',
    call: '55,66,77,88,99,TT,JJ,AQo,ATs,AJs,KQs,QJs,JTs,T9s,98s,87s,76s',
  },
  BB_vs_UTG1: {
    threeBet: 'JJ,QQ,KK,AA,AKs,AKo,AQs,AQo',
  ...
  BB_vs_HJ: {
    threeBet: '99,TT,JJ,QQ,KK,AA,AKs,AKo,AQs,AQo,AJs,A5s,A4s,KQs,KJs',
    call: '22,33,44,55,66,77,88,A9s,ATs,AJo,KTs,KQo,QTs,QJs,QJo,JTs,JTo,T9s,98s,87s,76s,65s,54s,T9o',
  },
  BB_vs_CO: {
    threeBet: '99,TT,JJ,QQ,KK,AA,AKs,AKo,AQs,AQo,A5s,A4s,A3s,KQs,KJs,QJs,JTs,T9s',
    call: '22,33,44,55,66,77,88,A2s,A6s,A7s,A8s,A9s,ATs,AJs,AJo,ATo,K8s,K9s,KTs,KJo,KQo,Q9s,QTs,QJo,QTo,J9s,JTo,T8s,T9o,98s,97s,87s,86s,76s,75s,65s,64s,54s,43s,53s',
  },
  BB_vs_BTN: {
    threeBet:
      '66,77,88,99,TT,JJ,QQ,KK,AA,AKs,AKo,AQs,AQo,A5s,A4s,A3s,A2s,KQs,KJs,QJs,JTs,T9s,98s,87s,76s',
