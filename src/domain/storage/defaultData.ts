...
export const createEmptyDrillStats = () => ({
  ...
  postflop_flop_cbet: { attempts: 0, correct: 0 },
  postflop_facing_flop_cbet: { attempts: 0, correct: 0 },
...
export const createEmptyDrillResponseMs = () => ({
  ...
  postflop_flop_cbet: 0,
  postflop_facing_flop_cbet: 0,
...
export const createDefaultSession = (): SessionStats => ({
  ...
  postflop: {
    ...
    flopCBet: { attempts: 0, correct: 0, totalResponseMs: 0 },
    facingFlopCBet: { attempts: 0, correct: 0, totalResponseMs: 0 },
  },
});
